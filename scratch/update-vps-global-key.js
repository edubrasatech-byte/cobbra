...
console.log('⚡ Configurando AUTHENTICATION_GLOBAL_API_KEY na Evolution API da VPS...');

conn.on('ready', () => {
  const cmd = `
    # 1. Escreve o docker-compose.yml completo e correto com a chave de autenticacao global da v2
...
EOF
    ...
    echo "=== VERIFICANDO DOCKER APÓS CONFIGURAR CHAVE GLOBAL V2 ==="
    sleep 5
    docker ps
  `;
