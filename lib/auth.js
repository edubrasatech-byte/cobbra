...
function getUserFromRequest(request) {
  ...
  const user = queryOne('SELECT id, name, email, role, phone, pix_key, pix_key_type, business_name, business_description, plan, plan_expires_at, status, onboarding_completed, created_at FROM users WHERE id = ?', [decoded.id]);
  return user || null;
}
