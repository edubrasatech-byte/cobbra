                    ...
                    <td className="py-4 px-6 text-right">
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          className="p-1.5 rounded-lg bg-surface-theme hover:bg-card-hover-theme border border-theme text-primary-theme hover:text-primary-theme cursor-pointer transition-colors"
                          title="Editar"
                        >
