              ...
              >
                ...
                <div className="flex gap-2 border-t border-theme pt-4 mt-auto">
                  <button
                    ...
                    className="flex-1 py-2 rounded-xl bg-surface-theme hover:bg-slate-700 border border-theme text-primary-theme hover:text-white text-xs font-bold transition-all cursor-pointer text-center"
                  >
